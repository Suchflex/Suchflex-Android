 ...
 ******************************************************************************/
package com.qactivo.distribit.boinc.attach;
...
import com.qactivo.distribit.boinc.client.PersistentStorage;
...
// --END-- monitor service binding
    ...
    public class ProjectAttachWrapper implements Serializable {
	...
	public String mapErrorNumToString(int code) {
