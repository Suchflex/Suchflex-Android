...
import com.qactivo.distribit.boinc.rpc.Message;
...
interface IMonitor {
    ...
    List<com.qactivo.distribit.boinc.rpc.Message> getEventLogMessages(in int seq, in int num);  // implement: call clientInterface.getEventLogMessages(int, Integer);
    List<com.qactivo.distribit.boinc.rpc.Message> getMessages(in int seq);        // implement: call clientInterface.getMessages(Integer);
    ...
    String getLastErrorMessage(); // clientInterface.getLastErrorMessage();
