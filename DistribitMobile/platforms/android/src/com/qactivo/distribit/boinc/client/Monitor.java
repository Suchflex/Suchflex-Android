 ...
 ******************************************************************************/
package com.qactivo.distribit.boinc.client;

import com.qactivo.distribit.boinc.utils.*;
...
import com.qactivo.distribit.R;
import com.qactivo.distribit.boinc.mutex.BoincMutex;
import com.qactivo.distribit.boinc.rpc.AccountIn;
import com.qactivo.distribit.boinc.rpc.AccountOut;
import com.qactivo.distribit.boinc.rpc.AcctMgrRPCReply;
import com.qactivo.distribit.boinc.rpc.CcState;
import com.qactivo.distribit.boinc.rpc.CcStatus;
import com.qactivo.distribit.boinc.rpc.GlobalPreferences;
import com.qactivo.distribit.boinc.rpc.HostInfo;
import com.qactivo.distribit.boinc.rpc.ImageWrapper;
import com.qactivo.distribit.boinc.rpc.Notice;
import com.qactivo.distribit.boinc.rpc.Project;
...
import com.qactivo.distribit.boinc.rpc.Transfer;
...
// public methods for Activities
    ...
    public void forceRefresh() {
        System.out.println("monitor force refresh");
...
// remote service
	private final IMonitor.Stub mBinder = new IMonitor.Stub() {
		...
		@Override
		public List<com.qactivo.distribit.boinc.rpc.Message> getMessages(int seq) throws RemoteException {
			return clientInterface.getMessages(seq);
		}
		
		@Override
		public List<com.qactivo.distribit.boinc.rpc.Message> getEventLogMessages(int seq, int num)
				throws RemoteException {
		...
		public String getLastErrorMessage(){
			return clientInterface.getLastErrorMessage();
		}
